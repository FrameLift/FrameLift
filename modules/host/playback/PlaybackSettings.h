...
#define FRAMELIFT_HWDEC_MODE_DESC                                                                                      \
    "Video acceleration mode: off, auto, vulkan-zero-copy, vulkan, cuda, d3d11va, dxva2, or vaapi."
#else
#define FRAMELIFT_HWDEC_MODE_DESC "Video acceleration mode: off, auto, cuda, d3d11va, dxva2, or vaapi."
#endif
...
{
    reg.AddString(
        "playback.hwdecMode", s.hwdecMode, FRAMELIFT_HWDEC_MODE_DESC,
        [&s]
        {
    ...
    reg.AddBool(
        "playback.audioFileAutoLoad", s.audioFileAutoLoad, "Auto-load external audio files matching the opened media."
    );
