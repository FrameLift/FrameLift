...
private Q_SLOTS:
    ...
    void PixelsLatestWinsAndRecyclesBuffers()
    {
        ...
        gate.PublishPixels(first, 1, 1);
        gate.PublishPixels(second, 1, 1); // unconsumed pending is handed back to the producer
